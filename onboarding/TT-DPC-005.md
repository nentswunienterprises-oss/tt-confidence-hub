...
DATA PROTECTION CONSENT FORM (TT-DPC-005)
1. PURPOSE
This form records consent for the collection, processing, storage, and use of personal and
performance data within the Territorial Tutoring platform.
...
By participating in TT, all parties agree to the structured use of data as defined in this
document.
2. TYPES OF DATA COLLECTED
TT collects and processes the following:
...
Generate reports for parents/guardians
Ensure safeguarding and platform security
Compliance with POPIA, tax legislation, and any mandatory reporting requirements
...
stored securely within TT systems
...
5.1 TT implements reasonable technical and organisational measures to:
protect data against loss
prevent unauthorised access
ensure data integrity
5.2 Data is stored on secure systems and accessed only by authorised TT personnel.
6. DATA SHARING
6.1 TT does not sell personal data.
6.2 Data may be shared only:
internally within TT for operational purposes
...
7. DATA RETENTION
7.1 Data is retained for as long as necessary to:
operate the platform
maintain historical performance records
meet legal and compliance obligations
7.2 TT may retain anonymized data for:
system improvement
internal analysis
8. USER RIGHTS (POPIA)
...
lodge complaint with the Information Regulator of South Africa at
...
safeguarding
dispute resolution
9. DATA USE LIMITATIONS
Users may not:
record sessions independently without TT approval
distribute TT session recordings
share learner data outside the platform
All data remains under TT control.
10. CONSENT ACKNOWLEDGEMENT
By signing below, the user confirms:
...
11. DECLARATION
I confirm that:
I have read and understood this Data Protection Consent Form
I consent to the collection, processing, and storage of my data as described
I understand that participation in Territorial Tutoring requires this consent
Contractor Full Name: ______________________________________
Signature: ______________________________________
Date: __________________________________________
TT Representative: ______________________________
Print Name: Thendo Nentswuni
Date: ________________________________
Document Reference: TT-DPC-005