...
5.2 Data is stored on secure systems and accessed only by authorized Response Integrity personnel.
...
7.2 Response Integrity may retain anonymized data for:
system improvement
internal analysis
...
Users may not:
record sessions independently without Response Integrity approval
distribute Response Integrity session recordings
share learner data outside the platform
All data remains under Response Integrity control.
...
Document Reference: Response Integrity-DPC-005
