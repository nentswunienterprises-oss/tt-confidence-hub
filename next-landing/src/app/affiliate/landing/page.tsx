...
const fitSignals = [
  "You can identify real academic breakdown, not vague interest.",
  "You can qualify families accurately before moving anything forward.",
  "You can disqualify weak-fit conversations early instead of chasing volume.",
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-x-hidden bg-[#F7EFE7] text-[#1A1A1A]">
        ...
        <header className="fixed inset-x-0 top-0 z-50 border-b border-[#E7D8CA] backdrop-blur-md" style={{ backgroundColor: "rgba(247, 239, 231, 0.88)" }}>
          <div className="mx-auto grid h-16 max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-4 sm:h-20 sm:px-6 md:px-12">
            <Link href="/" className="inline-flex w-fit items-center gap-2 rounded-full px-3 py-2 text-sm font-medium text-[#1A1A1A] transition hover:bg-[#F3E5D9]">
              <ArrowLeft className="h-4 w-4" />
              Back
            </Link>
            <div className="hidden text-center md:block">
              <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#8A4B35]">Affiliate Gateway</p>
              <p className="mt-0.5 text-xl font-bold tracking-tight text-[#1A1A1A]">Education Growth Partner</p>
            </div>
            <Link href="/client/signup" className="justify-self-end rounded-full bg-[#B9382F] px-5 py-2 text-sm font-semibold text-white shadow-sm">
              Apply for Access
            </Link>
          </div>
        </header>
        ...
        <main>
          <section className="mx-auto max-w-7xl px-4 pb-12 pt-24 sm:px-6 md:px-12 md:pb-16 md:pt-28">
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
              <div className="overflow-hidden rounded-[34px] border border-[#E5D3C5] bg-[linear-gradient(135deg,#FFF9F3_0%,#F8EBDD_45%,#F0DFD0_100%)] shadow-[0_28px_90px_rgba(84,45,22,0.09)]">
                <div className="p-6 sm:p-7 lg:p-9 xl:p-10">
                  ...
                  <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                    <Link href="/client/signup" className="inline-flex items-center justify-center rounded-full bg-[#B9382F] px-8 py-3 font-semibold text-white shadow-sm">
                      Apply for Access
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                    <a href="#fit-check" className="inline-flex items-center justify-center rounded-full border border-[#D7C0AF] bg-white/70 px-8 py-3 font-semibold text-[#1A1A1A] transition hover:bg-white">
                      See If You Fit
                    </a>
                  </div>
              ...
              <div className="grid gap-4 xl:content-start">
                <div className="rounded-[28px] border border-[#2A211D] bg-[#1F1814] p-5 text-white shadow-[0_18px_50px_rgba(25,19,16,0.18)]">
                ...
                <div className="rounded-[28px] border border-[#E5D3C5] bg-white/82 p-5 shadow-sm">
                ...
                <div className="rounded-[28px] border border-[#DEC9B9] bg-[#F3E3D5] p-5 shadow-sm">
          ...
          <section id="fit-check" className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 md:px-12">
            <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="rounded-[30px] border border-[#2F2621] bg-[#201916] p-7 text-white shadow-sm sm:p-8">
          ...
          <section className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 md:px-12">
            <div className="grid gap-6 lg:grid-cols-[0.98fr_1.02fr]">
              <div className="rounded-[30px] border border-[#E4D2C4] bg-white p-7 shadow-sm sm:p-8">
              ...
              <div className="overflow-hidden rounded-[30px] border border-[#E0D1C3] bg-[#F0E2D5] shadow-sm">
              ...
              <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr]">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {principleCards.map((item) => (
                    <div key={item.title} className="rounded-[24px] border border-white/10 bg-[#221C18] p-6 text-white">
          ...
          <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 md:px-12 md:py-20">
            <div className="rounded-[32px] border border-[#E5D3C5] bg-white/82 px-6 py-10 text-center shadow-sm sm:px-10 sm:py-12">
              ...
              <Link href="/client/signup" className="mt-8 inline-flex rounded-full bg-[#B9382F] px-8 py-3 font-semibold text-white shadow-sm">
                Apply for Access
              </Link>
            </div>
          </section>
