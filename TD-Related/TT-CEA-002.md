...
adjust drill structure
simplify or “adapt” methods
introduce personal teaching styles
...
Failure to act on known deviations constitutes a breach.

4. NO SOFT ENFORCEMENT
The Territory Director agrees:
Relationships do not override system standards
Tutor comfort is not a priority over execution correctness
“Close enough” execution is not acceptable
...
Document breakdown patterns truthfully
Avoid omission of known issues
...
8. BREACH & REMOVAL
Immediate removal may occur if the Territory Director:
Allows system drift
Engages in unauthorized system changes
Fails to enforce standards
