...
- No gamification that rewards speed without accuracy.
...
- No language implying replacement of teachers
...
- It must not weaken standards
- It must not alter methodology
- It must not slow execution

Legibility to the state is secondary to fidelity to the mission.
