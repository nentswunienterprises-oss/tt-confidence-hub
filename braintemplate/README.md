...
1. Copy the `/braintemplate` folder structure into your own repo.
2. For each `.md` file, answer the questions specific to your project.
3. Commit the completed Brain to your repo.
4. Reference these files when planning changes, onboarding new contributors, or working with AI agents.
5. Keep the Brain updated as your project evolves; it is living documentation.
...
1. Open each `.md` file in this folder.
2. Answer every question for your project.
3. Commit the completed Brain.
4. Use these files as reference during development and AI-assisted work.
