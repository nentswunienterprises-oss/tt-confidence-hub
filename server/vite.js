            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.use(function (req, res, next) {
                        ...
                        try {
                            var clientTemplate = path.resolve(import.meta.dirname, "..", "client", "index.html");
                            var template = fs.readFileSync(clientTemplate, "utf-8");
                            template = template.replace("src=\"/src/main.tsx\"", "src=\"/src/main.tsx?v=".concat(nanoid(), "\""));
                            vite.transformIndexHtml(url, template).then(function (page) {
