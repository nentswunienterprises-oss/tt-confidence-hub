...
export default function OnlineTutorsWanted() {
    ...
    var applyPath = "/operational/signup";
    var tutorApplyPath = "".concat(applyPath, "?role=tutor"); // deep-link directly to tutor signup
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ backgroundColor: "rgba(255, 245, 237, 0.95)" }}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-center md:justify-between relative">
          ...
          <div className="absolute right-4 top-2 md:absolute md:right-12 md:top-4">
            <Button className="text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-3 rounded-full border-0 shadow-md" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate(tutorApplyPath); }} aria-label="Start application">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6 items-start">
          ...
          <Card className="p-6" style={{ backgroundColor: "white" }}>
            ...
            <p className="text-sm mb-4 break-words whitespace-normal" style={{ color: "#5A5A5A" }}>
              Apply <button type="button" aria-label="Apply at Territorial Tutoring operational signup" className="text-blue-600 hover:underline inline p-0 m-0" onClick={function () { return navigate(tutorApplyPath); }}>here</button> (create an account and apply to get started)
            </p>
            <p className="text-sm" style={{ color: "#5A5A5A" }}>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 pb-6 sm:pb-8 mb-6 sm:mb-8 border-b" style={{ borderColor: "#E5E5E5" }}>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2">
                <button onClick={function () { return navigate("/operational/landing"); }} className="text-xs sm:text-sm block hover:underline" style={{ color: "#5A5A5A" }}>
                  Become a Tutor
                </button>
                <button onClick={function () { return navigate("/affiliate/landing"); }} className="text-xs sm:text-sm block hover:underline" style={{ color: "#5A5A5A" }}>
                  Affiliate Program
                </button>
              </div>
            </div>
