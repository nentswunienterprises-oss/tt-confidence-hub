...
export default function MediaLanding() {
    return (<div className="min-h-screen bg-[#FFF5ED] flex items-center justify-center p-4">
      <div className="max-w-2xl w-full space-y-8">
        {/* Header */}
        <div className="space-y-4">
          <h1 className="text-6xl md:text-7xl tracking-tight text-[#1A1A1A]" style={{ fontFamily: 'Anton, sans-serif' }}>
            TT MEDIA
          </h1>
        ...
        <div className="space-y-4">
          <Link to="/media/carousel/library">
            <Button className="w-full h-14 text-lg bg-[#1A1A1A] hover:bg-[#1A1A1A]/90 text-white mb-3" style={{ fontFamily: 'Inter, sans-serif' }}>
              Carousel Library
            </Button>
          </Link>
          <Link to="/media/carousel/select">
            <Button className="w-full h-14 text-lg bg-[#E63946] hover:bg-[#E63946]/90 text-white" style={{ fontFamily: 'Inter, sans-serif' }}>
              Create Carousel
            </Button>
          </Link>
