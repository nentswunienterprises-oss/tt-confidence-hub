    ...
    return (<div className="space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2">
          Welcome back, {(studentInfo === null || studentInfo === void 0 ? void 0 : studentInfo.firstName) || "Champion"}! 🎓
        </h1>
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/30 hover:shadow-lg transition-all">
            ...
            <CardContent>
              <div className="text-3xl sm:text-5xl font-bold text-primary mb-1 sm:mb-2">
                {(stats === null || stats === void 0 ? void 0 : stats.bossBattlesCompleted) || 0}
              </div>
              ...
              <div className="mt-2 sm:mt-3 bg-primary/20 rounded-full h-1.5 sm:h-2">
                <div className="bg-primary h-1.5 sm:h-2 rounded-full transition-all" style={{ width: "".concat(Math.min((((stats === null || stats === void 0 ? void 0 : stats.bossBattlesCompleted) || 0) / 10) * 100, 100), "%") }}/>
              </div>
              <p className="text-[10px] sm:text-xs text-muted-foreground mt-1">
                Next milestone: {Math.ceil((((stats === null || stats === void 0 ? void 0 : stats.bossBattlesCompleted) || 0) + 1) / 10) * 10} battles
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-300 hover:shadow-lg transition-all">
            ...
            <CardContent>
              <div className="text-3xl sm:text-5xl font-bold text-purple-700 mb-1 sm:mb-2">
                {(stats === null || stats === void 0 ? void 0 : stats.solutionsUnlocked) || 0}
              </div>
              ...
              <div className="mt-2 sm:mt-3 bg-purple-200/50 rounded-full h-1.5 sm:h-2">
                <div className="bg-purple-600 h-1.5 sm:h-2 rounded-full transition-all" style={{ width: "".concat(Math.min((((stats === null || stats === void 0 ? void 0 : stats.solutionsUnlocked) || 0) / 20) * 100, 100), "%") }}/>
              </div>
              <p className="text-[10px] sm:text-xs text-purple-700 mt-1">
                Next milestone: {Math.ceil((((stats === null || stats === void 0 ? void 0 : stats.solutionsUnlocked) || 0) + 1) / 20) * 20} solutions
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-red-50 border-orange-300 hover:shadow-lg transition-all">
            ...
            <CardContent>
              ...
              <div className="mt-2 sm:mt-3 flex gap-0.5 sm:gap-1">
                {Array.from({ length: 7 }).map(function (_, i) { return (<div key={i} className={"flex-1 h-4 sm:h-8 rounded ".concat(i < ((stats === null || stats === void 0 ? void 0 : stats.currentStreak) || 0) % 7
                ? 'bg-orange-500'
                : 'bg-orange-200/50')}/>); })}
              </div>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-300 hover:shadow-lg transition-all">
            ...
            <CardContent>
              <div className="text-3xl sm:text-5xl font-bold text-green-700 mb-1 sm:mb-2">
                {(stats === null || stats === void 0 ? void 0 : stats.confidenceLevel) || 0}%
              </div>
              ...
              <div className="mt-2 sm:mt-3 bg-green-200/50 rounded-full h-1.5 sm:h-2">
                <div className="bg-green-600 h-1.5 sm:h-2 rounded-full transition-all" style={{ width: "".concat((stats === null || stats === void 0 ? void 0 : stats.confidenceLevel) || 0, "%") }}/>
              </div>
