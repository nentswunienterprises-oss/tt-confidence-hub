      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FFF5ED] to-[#F9E3D8] flex flex-col">
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-[#F3D2C1] w-full backdrop-blur-md" style={{ background: 'linear-gradient(135deg, #FFF5ED 0%, #F9E3D8 100%)', boxShadow: '0 2px 8px 0 rgba(233, 57, 70, 0.04)', backgroundColor: 'rgba(255,245,237,0.95)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-between">
            ...
            <span className="block md:hidden text-lg sm:text-2xl lg:text-4xl font-bold tracking-tight text-[#2D1A06] text-center mx-auto" style={{marginTop: '2px', marginBottom: '2px', maxWidth: '160px'}}>
              <span className="block leading-tight mb-1">Founding</span>
              <span className="block leading-tight">Tutor Cohort</span>
            </span>
            <span className="hidden md:block text-2xl lg:text-4xl font-bold tracking-tight text-[#2D1A1A]">FOUNDING TUTOR COHORT</span>
            <Button
        ...
        <main className="w-full max-w-3xl mx-auto px-4 sm:px-8 md:px-12 py-8 sm:py-12 flex-1">
          <section className="mb-8 sm:mb-10">
            <div className="rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 border border-[#F3D2C1] bg-white/90 max-w-md mx-auto">
              ...
              <div className="flex flex-col items-center mt-8 mb-4 px-2">
                <Button
                  size="lg"
                  className="w-full max-w-xs mx-auto px-6 py-4 rounded-full font-semibold mb-2 bg-[#E63946] hover:bg-[#C92B2B] transition-all border-0 shadow-xl text-base sm:text-lg mt-4"
                  style={{ color: "white" }}
                  onClick={() => navigate("/operational/signup?role=tutor")}
                >
