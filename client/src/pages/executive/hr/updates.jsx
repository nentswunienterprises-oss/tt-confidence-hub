...
export default function ExecutiveHRUpdates() {
    var _this = this;
      ...
      <Card className="border">
        ...
        <div className="divide-y max-h-[600px] overflow-y-auto">
          {!broadcasts || broadcasts.length === 0 ? (<div className="p-12 text-center">
            ...
            return (<div key={broadcast.id} className={"p-6 space-y-3 hover-elevate transition-colors ".concat(!isRead ? "bg-primary/5" : "")}>
