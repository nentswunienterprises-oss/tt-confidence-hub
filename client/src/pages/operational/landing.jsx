    ...
    return (<div className="min-h-screen" style={{ backgroundColor: "#FFF5ED" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ backgroundColor: "rgba(255, 245, 237, 0.95)" }}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-between">
          ...
          <Button className="text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-5 rounded-full border-0 shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate("/operational/signup"); }}>
            Sign In
          </Button>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-8 sm:pt-12 md:pt-20 pb-12 sm:pb-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-5 sm:space-y-8">
          ...
          <Button size="lg" className="text-base sm:text-lg font-semibold px-6 sm:px-8 py-4 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all border-0" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate("/operational/signup"); }}>
            Apply to Join
      ...
      <section className="py-20" style={{ backgroundColor: "#1A1A1A" }}>
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Tutor Role */}
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group" style={{ backgroundColor: "white" }} onClick={function () { return navigate("/operational/signup"); }}>
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" style={{ backgroundColor: "#E63946" }}>
              ...
              <ul className="space-y-3 mb-8">
                {["Student Rosters & Profiles", "Weekly Check-In Forms", "Progress Tracking & Reflections", "Feedback & Coaching Notes", "Growth Metrics Dashboard"].map(function (item, i) { return (<li key={i} className="flex items-center gap-3">
                    <Check className="w-5 h-5 flex-shrink-0" style={{ color: "#E63946" }}/>
                    <span style={{ color: "#5A5A5A" }}>{item}</span>
                  </li>); })}
              </ul>
              
              <Button className="w-full rounded-full py-6 font-semibold border-0" style={{ backgroundColor: "#E63946", color: "white" }}>
                Continue as Tutor
            ...
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group" style={{ backgroundColor: "white" }} onClick={function () { return navigate("/operational/signup"); }}>
              ...
              <ul className="space-y-3 mb-8">
                {["Tutor Performance Reports", "All Student Check-Ins (Territory-wide)", "Territory Analytics & KPIs", "Tutor Coaching & Feedback Management", "Enrollment & Retention Tracking"].map(function (item, i) { return (<li key={i} className="flex items-center gap-3">
                    <Check className="w-5 h-5 flex-shrink-0" style={{ color: "#E63946" }}/>
                    <span style={{ color: "#5A5A5A" }}>{item}</span>
                  </li>); })}
              </ul>
      ...
      <section className="py-20" style={{ backgroundColor: "#FFF5ED" }}>
        ...
        ].map(function (item, i) { return (<div key={i} className="flex gap-3">
      ...
      <section className="py-20" style={{ backgroundColor: "#E63946" }}>
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <Button size="lg" className="text-lg font-semibold px-10 py-6 rounded-full border-0" style={{ backgroundColor: "white", color: "#E63946" }} onClick={function () { return navigate("/operational/signup"); }}>
            Apply to Join
