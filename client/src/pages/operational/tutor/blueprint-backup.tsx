      ...
      <Card className="border-2 border-primary/30">
        <CardHeader className="bg-gradient-to-r from-primary to-primary/80 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-2xl">Module 3: The Real Response Integrity Intro Session Blueprint</CardTitle>
              <CardDescription className="text-white/95 text-lg mt-2">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-accent p-4 rounded-lg border border-primary/10">
                ...
                <ul className="space-y-2">
                  ...
                  <li>✓ Introduce Response Integrity's tools: Solutions Unlocked, Boss Battle Log</li>
                </ul>
              </div>
        ...
        <CardContent className="p-6 space-y-6">
          <div className="bg-accent p-6 rounded-lg border border-primary/10">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>• Set up the student's Response Integrity Identity</li>
    ...
    <div className="space-y-6">
      <Card className="border-2 border-primary/30">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <SectionCard
            id="module7-pause"
            title='✅ 1. The "Sacred Pause" Strategy'
            expanded={expandedSections["module7-pause"] || false}
            onToggle={() => toggleSection("module7-pause")}
            gradient="from-primary/90 to-primary"
          >
            <div className="space-y-4">
          ...
          <SectionCard
            id="module7-reset"
            title="✅ 2. Emotional Reset Checklist"
            expanded={expandedSections["module7-reset"] || false}
            onToggle={() => toggleSection("module7-reset")}
            gradient="from-primary to-primary/70"
          >
            <div className="space-y-4">
          ...
          <SectionCard
            ...
            expanded={expandedSections["module7-rhythm"] || false}
            onToggle={() => toggleSection("module7-rhythm")}
            gradient="from-primary/90 to-primary/80"
          >
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-accent p-4 rounded-lg border border-primary/10">
                  <p className="font-bold mb-2 text-primary">Response Integrity's Way</p>
                  <ul className="space-y-1 text-sm">
