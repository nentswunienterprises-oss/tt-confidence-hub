...
export default function OnlineTutorsWantedPlain() {
    ...
    var tutorApplyPath = "".concat(applyPath, "?role=tutor");
    return (<div className="min-h-screen" style={{ backgroundColor: "#FFF5ED" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ backgroundColor: "rgba(255, 245, 237, 0.95)" }}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Button className="text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-5 rounded-full border-0 shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate(tutorApplyPath); }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-8 sm:pt-12 md:pt-20 pb-8 sm:pb-12">
        <div className="text-center mb-6 sm:mb-10">
          ...
          <div className="mt-6">
            <Button size="lg" className="w-full sm:w-auto px-6 py-3 rounded-full font-semibold" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate(tutorApplyPath); }}>
              Apply Now
            </Button>
          </div> 
        ...
        <Card className="p-6 mb-6" style={{ backgroundColor: "white" }}>
          ...
          <p className="mt-4 text-sm" style={{ color: "#5A5A5A" }}>
            Apply <button type="button" aria-label="Apply at Territorial Tutoring operational signup" className="text-blue-600 hover:underline inline p-0 m-0" onClick={function () { return navigate(tutorApplyPath); }}>Here</button>
          </p>
      ...
      <div className="block md:hidden mt-6 mb-8 px-4 sm:px-0">
        <div className="max-w-md mx-auto">
          <Button className="w-full py-4 font-semibold rounded-full shadow-lg" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate(tutorApplyPath); }}>
