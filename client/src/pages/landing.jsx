...
import { GraduationCap, Users, Target, Heart, Sparkles, ArrowRight, Check, Star, } from "lucide-react";
export default function Landing() {
    return (<div className="min-h-screen" style={{ backgroundColor: "#FFF5ED" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ backgroundColor: "rgba(255, 245, 237, 0.95)" }}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/images/logo.png" alt="Territorial Tutoring" className="h-8 sm:h-12 md:h-14 object-contain" onError={function (e) {
            // Fallback if image doesn't exist yet
            e.currentTarget.style.display = 'none';
            var fallback = e.currentTarget.nextElementSibling;
            if (fallback)
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Button variant="ghost" className="text-sm sm:text-base font-medium hover:bg-transparent px-2 sm:px-4" style={{ color: "#1A1A1A" }} onClick={function () { return window.location.href = "/auth?mode=login"; }}>
              Log In
            </Button>
            <Button className="text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-5 rounded-full border-0 shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return window.location.href = "/auth?mode=signup"; }}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-5 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
              <Button size="lg" className="text-base sm:text-lg font-semibold px-6 sm:px-8 py-4 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all border-0" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return window.location.href = "/auth?mode=signup"; }}>
                Start Your Journey
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2"/>
              </Button>
              <Button size="lg" variant="outline" className="text-base sm:text-lg font-medium px-6 sm:px-8 py-4 sm:py-6 rounded-full" style={{ borderColor: "#1A1A1A", borderWidth: "2px", color: "#1A1A1A", backgroundColor: "transparent" }} onClick={function () { return window.location.href = "/auth?mode=login"; }}>
            ...
            <div className="flex items-center gap-4 sm:gap-6 pt-2 sm:pt-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map(function (i) { return (<div key={i} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-xs sm:text-sm font-medium" style={{
          ...
          <div className="relative">
            ...
            <img src="/images/Benefits-of-Online-Tutoring-1-1080x589.png" alt="Student learning with confidence" className="relative rounded-3xl shadow-2xl w-full object-cover" style={{ aspectRatio: "4/3" }} onError={function (e) {
            ...
            <div className="hidden relative rounded-3xl w-full flex items-center justify-center" style={{ aspectRatio: "4/3", backgroundColor: "#FFF0F0" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            },
            {
                ...
                <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6" style={{ backgroundColor: "#E63946" }}>
      ...
      <section className="py-10 sm:py-16" style={{ backgroundColor: "#E63946" }}>
        ...
        ].map(function (stat, index) { return (<div key={index}>
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "#FFF5ED" }}>
        ...
        ].map(function (testimonial, index) { return (<Card key={index} className="p-5 sm:p-6 md:p-8 border-0 shadow-lg" style={{ backgroundColor: "white" }}>
                <div className="flex gap-0.5 sm:gap-1 mb-3 sm:mb-4">
                  {[1, 2, 3, 4, 5].map(function (star) { return (<Star key={star} className="w-4 h-4 sm:w-5 sm:h-5 fill-current" style={{ color: "#E63946" }}/>); })}
                </div>
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "#FFF5ED" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {/* Parent/Student */}
            <Card className="p-5 sm:p-6 md:p-8 border-2 hover:border-[#E63946] cursor-pointer transition-all hover:shadow-xl group" style={{ borderColor: "#E5E5E5" }} onClick={function () { return window.location.href = "/portal-landing"; }}>
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform" style={{ backgroundColor: "#FFF0F0" }}>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {["Access to dedicated tutors", "Track confidence growth", "Weekly progress updates", "Parent dashboard"].map(function (item, i) { return (<li key={i} className="flex items-center gap-2 sm:gap-3">
              ...
              <Button className="w-full rounded-full py-4 sm:py-6 font-semibold group-hover:shadow-lg transition-all text-sm sm:text-base border-0" style={{ backgroundColor: "#E63946", color: "white" }}>
                Get Started
            ...
            {/* Tutor */}
            <Card className="p-5 sm:p-6 md:p-8 border-2 hover:border-[#E63946] cursor-pointer transition-all hover:shadow-xl group" style={{ borderColor: "#E5E5E5" }} onClick={function () { return window.location.href = "/auth?mode=signup"; }}>
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform" style={{ backgroundColor: "#FFF0F0" }}>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {["Flexible schedule", "Meaningful work", "Training provided", "Grow your income"].map(function (item, i) { return (<li key={i} className="flex items-center gap-2 sm:gap-3">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" style={{ color: "#E63946" }}/>
                    <span className="text-sm sm:text-base" style={{ color: "#5A5A5A" }}>{item}</span>
                  </li>); })}
              </ul>
            ...
            {/* Team */}
            <Card className="p-5 sm:p-6 md:p-8 border-2 hover:border-[#E63946] cursor-pointer transition-all hover:shadow-xl group sm:col-span-2 md:col-span-1" style={{ borderColor: "#E5E5E5" }} onClick={function () { return window.location.href = "/auth?mode=login"; }}>
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform" style={{ backgroundColor: "#FFF0F0" }}>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {["Manage your pods", "Track student progress", "Access broadcasts", "View analytics"].map(function (item, i) { return (<li key={i} className="flex items-center gap-2 sm:gap-3">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" style={{ color: "#E63946" }}/>
                    <span className="text-sm sm:text-base" style={{ color: "#5A5A5A" }}>{item}</span>
                  </li>); })}
              </ul>
              <Button variant="outline" className="w-full rounded-full py-4 sm:py-6 font-semibold border-2 group-hover:shadow-lg transition-all text-sm sm:text-base" style={{ borderColor: "#1A1A1A", color: "#1A1A1A" }}>
                Sign In
                <ArrowRight className="w-4 h-4 ml-2"/>
              </Button>
            </Card>
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "#1A1A1A" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Button size="lg" className="text-base sm:text-lg font-semibold px-6 sm:px-10 py-4 sm:py-6 rounded-full border-0 shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return window.location.href = "/auth?mode=signup"; }}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex gap-4 justify-center md:justify-end mt-2">
                <button onClick={function () { return window.location.href = "/privacy-policy"; }} className="text-xs hover:underline" style={{ color: "#5A5A5A" }}>
                  Privacy Policy
                </button>
                <button onClick={function () { return window.location.href = "/terms-of-use"; }} className="text-xs hover:underline" style={{ color: "#5A5A5A" }}>
                  Terms of Use
                </button>
              </div>
            </div>
