...
import { QrCode, Compass, Check, ArrowRight, ArrowLeft } from "lucide-react";
    ...
    return (<div className="min-h-screen" style={{ backgroundColor: "#FFF5ED" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ backgroundColor: "rgba(255, 245, 237, 0.95)" }}>
        <div className="max-w-7xl mx-auto px-3 sm:px-6 md:px-12 h-16 sm:h-20 flex items-center justify-between">
          ...
          <Button className="text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 sm:py-5 rounded-full border-0 shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate("/affiliate/signup"); }}>
            Sign In
          </Button>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-8 sm:pt-12 md:pt-20 pb-12 sm:pb-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-5 sm:space-y-8">
          ...
          <Button size="lg" className="text-base sm:text-lg font-semibold px-6 sm:px-8 py-4 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all border-0" style={{ backgroundColor: "#E63946", color: "white" }} onClick={function () { return navigate("/affiliate/signup"); }}>
            Enter the System
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "white" }}>
        ...
        ].map(function (step) { return (<Card key={step.num} className="p-3 sm:p-6 border-0 shadow-lg text-center" style={{ backgroundColor: "#FFF5ED" }}>
                <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-5" style={{ backgroundColor: "#FFF0F0", border: "2px solid #E63946" }}>
                  <span className="text-base sm:text-xl" style={{ fontFamily: "Georgia, serif", fontStyle: "italic", color: "#E63946", fontWeight: "600" }}>
                    {step.num}
                  </span>
                </div>
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "#1A1A1A" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-8 max-w-5xl mx-auto">
            {/* Affiliate */}
            <Card className="p-4 sm:p-8 border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group" style={{ backgroundColor: "white" }} onClick={function () { return navigate("/affiliate/signup"); }}>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                {["Unique QR & Links", "Live Enrollment Tracking", "Transparent Commissions", "Performance Feedback", "Approved Messaging"].map(function (item, i) { return (<li key={i} className="flex items-center gap-2 sm:gap-3">
            ...
            <Card className="p-4 sm:p-8 border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group" style={{ backgroundColor: "white" }} onClick={function () { return navigate("/affiliate/signup"); }}>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                {["Multiple Campaign Links", "School Partnerships", "Pod-Level Tracking", "Bonus Eligibility", "Strategic Oversight"].map(function (item, i) { return (<li key={i} className="flex items-center gap-2 sm:gap-3">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" style={{ color: "#E63946" }}/>
                    <span className="text-xs sm:text-base" style={{ color: "#5A5A5A" }}>{item}</span>
                  </li>); })}
              </ul>
      ...
      <section className="py-12 sm:py-20" style={{ backgroundColor: "#E63946" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 text-center">
          ...
          <Button size="lg" className="text-base sm:text-lg font-semibold px-6 sm:px-10 py-4 sm:py-6 rounded-full border-0" style={{ backgroundColor: "white", color: "#E63946" }} onClick={function () { return navigate("/affiliate/signup"); }}>
            Enter the System
          </Button>
        </div>
      </section>
