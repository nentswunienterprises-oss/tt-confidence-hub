        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section>
            ...
            <Card className="p-4 sm:p-6 mb-4 sm:mb-6 border-l-4 border-l-primary bg-card hover:shadow-md transition-shadow">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-muted/40 p-3 sm:p-5 rounded-lg border border-muted">
                  <p className="font-semibold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">Important:</p>
                  <p className="text-foreground text-xs sm:text-base">
                    If no real need is discovered, walk away. Discovery is about finding fit, not forcing a sale.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <section>
            ...
            <p className="text-foreground mb-6 sm:mb-8 text-sm sm:text-base">
              This is the <strong>best system to follow for prospecting encounters</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <Card className="p-4 sm:p-8 bg-gradient-to-r from-primary/5 to-accent/50 border border-primary/20 hover:shadow-md transition-shadow">
              <blockquote className="text-sm sm:text-lg font-semibold text-foreground border-l-4 border-l-primary pl-4 sm:pl-6">
