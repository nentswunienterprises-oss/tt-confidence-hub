      ...
      <DialogContent className="max-w-4xl max-h-[85vh]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {studentName}'s Tracking Systems
          </DialogTitle>
          <DialogDescription>
            View all sessions, parent reports, and TD feedback
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="sessions" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="reports">
              ...
              Parent Reports ({trackingData?.parentReports?.length || 0})
            </TabsTrigger>
            <TabsTrigger value="feedback">
              <MessageSquare className="w-4 h-4 mr-2" />
              TD Feedback ({trackingData?.tdFeedback?.length || 0})
            </TabsTrigger>
          </TabsList>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {session.student_mood && (
                                <Badge variant="secondary">Mood: {session.student_mood}</Badge>
                              )}
                              {session.confidence_score && (
                                <Badge className="bg-blue-100 text-blue-800">
                                  Confidence: {session.confidence_score}/10
                                </Badge>
                              )}
                            </div>
                          </div>
