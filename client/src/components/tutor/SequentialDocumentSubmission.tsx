          ...
          {getDocumentStatus(currentStep) === "rejected" && (
            <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
              ...
              <p className="text-sm text-red-700">
                {({
                  1: applicationStatus?.doc1SubmissionRejectionReason,
                  2: applicationStatus?.doc2SubmissionRejectionReason,
                  3: applicationStatus?.doc3SubmissionRejectionReason,
                  4: applicationStatus?.doc4SubmissionRejectionReason,
                  5: applicationStatus?.doc5SubmissionRejectionReason,
                  6: applicationStatus?.doc6SubmissionRejectionReason,
