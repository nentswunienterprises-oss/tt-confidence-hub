...
export default function ProposalView(_a) {
    var _b, _c;
    var proposal = _a.proposal, _d = _a.showActions, showActions = _d === void 0 ? false : _d, onAccept = _a.onAccept, onDecline = _a.onDecline, _e = _a.isProcessing, isProcessing = _e === void 0 ? false : _e;
    console.log("📋 ProposalView rendering with data:", proposal);
    var studentName = ((_b = proposal.student) === null || _b === void 0 ? void 0 : _b.name) || "Your Child";
    var tutorName = ((_c = proposal.tutor) === null || _c === void 0 ? void 0 : _c.name) || "Your Tutor";
    return (<div className="space-y-6">
      ...
      {proposal.tutor && (<Card>
          ...
          <CardContent className="space-y-3">
            {proposal.tutor.bio && (<p className="text-sm text-muted-foreground">{proposal.tutor.bio}</p>)}
            <div className="flex gap-4 text-sm">
              {proposal.tutor.email && (<div>📧 {proposal.tutor.email}</div>)}
              {proposal.tutor.phone && (<div>📱 {proposal.tutor.phone}</div>)}
            </div>
          </CardContent>
        </Card>)}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {proposal.confidenceTriggers && (<div>
            ...
            {proposal.confidenceKillers && (<div>
      ...
      {(proposal.futureIdentity || proposal.wantToRemembered || proposal.hiddenMotivations || proposal.internalConflict) && (<Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
          ...
          <CardContent className="space-y-4">
            ...
            {proposal.hiddenMotivations && (<div>
      ...
      <Card className="border-2 border-primary">
        ...
        ].map(function (item, idx) { return (<div key={idx} className="flex items-start gap-2">
      ...
      {showActions && (<Card className="border-2 border-primary">
          <CardContent className="pt-6">
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={onDecline} disabled={isProcessing} className="flex-1 gap-2" size="lg">
                <X className="w-4 h-4"/>
                Decline
              </Button>
              <Button onClick={onAccept} disabled={isProcessing} className="flex-1 gap-2" size="lg">
