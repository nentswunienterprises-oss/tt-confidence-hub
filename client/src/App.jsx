...
function Router() {
    return (<Routes>
      ...
      <Route path="/responseconditioningsystem/clarity" element={<ResponseConditioningClarity />}/>
      <Route path="/responseconditioningsystem/structured-execution" element={<ResponseConditioningStructuredExecution />}/>
      <Route path="/responseconditioningsystem/controlled-discomfort" element={<ResponseConditioningControlledDiscomfort />}/>
      <Route path="/responseconditioningsystem/time-pressure-stability" element={<ResponseConditioningTimePressureStability />}/>
      <Route path="/responseconditioningsystem/transformation-phases" element={<Navigate to="/responseconditioningsystem/clarity" replace/>}/>
      <Route path="/responseconditioningsystem/transformation-phases/clarity" element={<ResponseConditioningClarity />}/>
      <Route path="/responseconditioningsystem/transformation-phases/structured-execution" element={<ResponseConditioningStructuredExecution />}/>
      <Route path="/responseconditioningsystem/transformation-phases/controlled-discomfort" element={<ResponseConditioningControlledDiscomfort />}/>
      <Route path="/responseconditioningsystem/transformation-phases/time-pressure-stability" element={<ResponseConditioningTimePressureStability />}/>
      <Route path="/responseconditioningsystem/how-to-model" element={<ResponseConditioningHowToModel />}/>
      <Route path="/responseconditioningsystem/execution-standards/how-to-model" element={<ResponseConditioningHowToModel />}/>
      <Route path="/responseconditioningsystem/how-to-guide" element={<ResponseConditioningHowToGuide />}/>
      <Route path="/responseconditioningsystem/execution-standards/how-to-guide" element={<ResponseConditioningHowToGuide />}/>
      <Route path="/responseconditioningsystem/how-to-use-boss-battles" element={<ResponseConditioningHowToUseBossBattles />}/>
      <Route path="/responseconditioningsystem/execution-standards/how-to-use-boss-battles" element={<ResponseConditioningHowToUseBossBattles />}/>
      <Route path="/responseconditioningsystem/what-not-to-do" element={<ResponseConditioningWhatNotToDo />}/>
      <Route path="/responseconditioningsystem/execution-standards/what-not-to-do" element={<ResponseConditioningWhatNotToDo />}/>
      <Route path="/responseconditioningsystem/emotional-discipline-under-discomfort" element={<ResponseConditioningEmotionalDisciplineUnderDiscomfort />}/>
      <Route path="/responseconditioningsystem/execution-standards/emotional-discipline-under-discomfort" element={<ResponseConditioningEmotionalDisciplineUnderDiscomfort />}/>
      <Route path="/responseconditioningsystem/what-changes-in-the-student" element={<ResponseConditioningWhatChangesInTheStudent />}/>
      <Route path="/responseconditioningsystem/system-intelligence/what-changes-in-the-student" element={<ResponseConditioningWhatChangesInTheStudent />}/>
      <Route path="/responseconditioningsystem/signs-of-progress" element={<ResponseConditioningSignsOfProgress />}/>
      <Route path="/responseconditioningsystem/system-intelligence/signs-of-progress" element={<ResponseConditioningSignsOfProgress />}/>
      <Route path="/responseconditioningsystem/breakdown-patterns" element={<ResponseConditioningBreakdownPatterns />}/>
      <Route path="/responseconditioningsystem/system-intelligence/breakdown-patterns" element={<ResponseConditioningBreakdownPatterns />}/>
      <Route path="/responseconditioningsystem/before-vs-after" element={<ResponseConditioningBeforeVsAfter />}/>
      <Route path="/responseconditioningsystem/system-intelligence/before-vs-after" element={<ResponseConditioningBeforeVsAfter />}/>
      <Route path="/responseconditioningsystem/intro-session-structure" element={<ResponseConditioningIntroSessionStructure />}/>
      <Route path="/responseconditioningsystem/session-infrastructure/intro-session-structure" element={<ResponseConditioningIntroSessionStructure />}/>
      <Route path="/responseconditioningsystem/session-flow-control" element={<ResponseConditioningSessionFlowControl />}/>
      <Route path="/responseconditioningsystem/session-infrastructure/session-flow-control" element={<ResponseConditioningSessionFlowControl />}/>
      <Route path="/responseconditioningsystem/logging-system" element={<ResponseConditioningLoggingSystem />}/>
      <Route path="/responseconditioningsystem/session-infrastructure/logging-system" element={<ResponseConditioningLoggingSystem />}/>
