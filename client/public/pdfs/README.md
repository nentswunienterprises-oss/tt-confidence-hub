...
7. `Module 7 - Time Mastery for Soul-Led Teachers.pdf`

## PowerShell Command

You can use this PowerShell command to copy all files at once:

```powershell
Copy-Item "C:\Users\Thend\Downloads\Module*.pdf" "C:\Users\Thend\Downloads\Technology\PodDigitizer\client\public\pdfs\"
```
